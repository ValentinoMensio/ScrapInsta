...
def upgrade() -> None:
    ...
    op.execute('CREATE INDEX idx_profile_analysis_analyzed_at ON profile_analysis(analyzed_at DESC)')
...
def downgrade() -> None:
    ...
    op.execute('DROP INDEX IF EXISTS idx_profile_analysis_analyzed_at ON profile_analysis')
